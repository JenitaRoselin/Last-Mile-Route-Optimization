...
import { AuthProvider, useAuth } from "@/lib/auth-context";
import UrgentOverlay from "@/components/UrgentOverlay";
import VoiceBotFAB from "@/components/VoiceBotFAB"; // 1. Added VoiceBot Import
import Colors from "@/constants/colors";
import { ActivityIndicator, View } from "react-native";
...
function RootLayoutNav() {
  ...
  return (
    <AppProvider>
      ...
      {/* 2. Added the VoiceBot right next to your UrgentOverlay */}
      {/* It only renders if the user is logged in, preventing it from showing on login screens */}
      {user && (
        <>
          <UrgentOverlay />
          <VoiceBotFAB />
